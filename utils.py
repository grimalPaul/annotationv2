...
# on met en place seulement une seule question
...
class DataSession:
    ...
    def __init__(self, path_guidance, path_wo_guidance):
        ...
        st.nquestions_stage1 = st.secrets.access_credentials.nquestions_stage1
        st.nquestions_stage2 = st.secrets.access_credentials.nquestions_stage2
        self.question_order = {
            0: np.random.permutation(self.dataset[0].get_ids_question())[
                0 : st.nquestions_stage1
            ],
            1: np.random.permutation(
                self.dataset[1].get_ids_question(),
            )[0 : st.nquestions_stage2],
        }
